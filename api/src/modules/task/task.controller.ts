...
export class TaskController {
  ...
  @ApiQuery({
    ...
    required: false,
    description:
      "Filter by task status. Can be one of: PENDING, IN_PROGRESS, COMPLETED, CANCELLED",
    isArray: true,
  })
  @ApiQuery({
    name: "dueDateStart",
    required: false,
    description:
      "Start date for filtering tasks by due date. Format: YYYY-MM-DD",
  })
  @ApiQuery({
    name: "dueDateEnd",
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    description:
      "Sort tasks by the given field. Can be one of: priority, status, dueDate, none",
  })
  @ApiQuery({
    name: "sort",
    required: false,
  ...
  @ApiQuery({
    ...
    required: true,
    description:
      "Filter to only show tasks belonging to the logged-in user. true/false",
    default: false,
  })
  async findAll(
    @Req() req: Request,
